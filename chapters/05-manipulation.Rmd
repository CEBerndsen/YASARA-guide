...
It is possible to take the views in Figure \@ref(fog:stylepics) and apply them to a subset of amino acids or atoms in YASARA. 
...
```{r colormenu, eval = TRUE, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="YASARA color menu", out.width="150%"}
knitr::include_graphics("../YASARA_guide/images/colormenu.PNG")
...
You can change these feature color schemes by:
