...
```{r opening, echo=FALSE, warning=FALSE, message=FALSE, fig.height=2, fig.cap="The initial YASARA screen", fig.align='center', out.width="120%"}


knitr::include_graphics("../YASARA_guide/images/opening.PNG")
...
include_graphics("../YASARA_guide/images/littleconsole.PNG")
...
```{r seqbar, echo=FALSE, warning=FALSE, message=FALSE, fig.height=2, fig.cap="The initial YASARA screen", fig.align='center', out.width="120%"}

knitr::include_graphics("../YASARA_guide/images/sequencebar.PNG")
...
```{r pop, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Example of the pop-up menu in YASARA", fig.align='center'}

include_graphics("../YASARA_guide/images/pop-menu.png")
...
```{r helpind, echo=FALSE, warning=FALSE, message=FALSE,fig.cap="Results of using SearchDoc part 1: Initial search results", fig.align='center'}

include_graphics("../YASARA_guide/images/helpindex.PNG")
...
include_graphics("../YASARA_guide/images/helppage1.PNG")
...
## File system {#files}
```{r filetree, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="File folders created upon installing YASARA in Windows", fig.align='center'}

include_graphics("../YASARA_guide/images/filetree.PNG")
