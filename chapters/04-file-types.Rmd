...
pdbh <- image_border(image_background(pdbat, "white"), "#FFFFFF", "0x50")
...
# Load a molecule into the window so we can see the effects of each command
LoadPDB 1crn
...
The general YASARA syntax or grammar for commands, is Action, Level and then the specifics of the molecule or part of the molecule to affect. 
