...
```{r label = os, echo=FALSE, warning=FALSE, message=FALSE, fig.height=2}
library(cowplot)
library(magick)

pc <- image_read("../images/This_PC.PNG")
prop <- image_read("../images/Sys_prop.PNG")
os <- image_read("../images/Sys_type.PNG")
